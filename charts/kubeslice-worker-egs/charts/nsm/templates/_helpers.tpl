...
Priority: Parent global config > NSM-specific config > default
*/}}
{{- define "imagePullSecrets.secretName" -}}
    ...
    {{- else if .Values.global.nsm_docker_existingImagePullSecret -}}
...
Priority: Don't create if parent manages secrets OR NSM has existing secret
*/}}

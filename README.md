...
| `global_helm_repo_url`              | URL of the global Helm repository from which charts will be pulled.                                               | `https://smartscaler.nexus.aveshalabs.
io/repository/kubeslice-egs-helm-ent-prod`                     |

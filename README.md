...
1. **📝 Registration:**
   - Complete the registration process at [EGS Registration](https://avesha.io/egs-registration) to receive the image pull secrets required for running the script.
